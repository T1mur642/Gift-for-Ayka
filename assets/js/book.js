...
const pages = [
    ...
    { 
        ...
        content: `
            ...
            <p style="margin-top:10px;">Ich nahm mir Ausgang, um einfach den Kopf freizubekommen, fest davon überzeugt, dass es vorbei ist. Ich saß allein im Café, rauchte, trank Kaffee und versuchte, zu mir zu kommen. Du hast angerufen. Hast gefragt, wo ich bin, und bist zu der Allee gekommen, wo am 8. Februar alles zwischen uns begann. Ich setzte mich auf die Bank und sagte kalt: „Sag alles, was noch übrig ist. Ich bin nicht hier, um mich zu versöhnen.“</p>
